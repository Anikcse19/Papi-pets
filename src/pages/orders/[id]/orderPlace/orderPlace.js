  ...
  return (
    <div id="placeOrder">
      ...
      <div className="header !h-[60px] ">
        ...
        <div className="shap_header">
          <img src="/img/shap-orange.png" alt="shape_top" />
        </div>
      </div>
      <div className=" !bg-transparent" style={{ backgroundColor: "#f9fae8" }}>
        <div className="text_res w-75">
          <h2 className="msg_thanks w-auto">
            à Besoin de <span className=""></span> Calories / Jour
          </h2>
          <p>
            Nous avons concocté pour votre petite bête un programme alimentaire
            personnalisé goût .
          </p>
          <h2 className="msg_thanks livrasion w-auto text-[22px] mt-2">
            Une fois que votre essai aura été validé, la fréquence de livraison
            sera automatiquement réglée sur une fois toutes les 7 jours
          </h2>
        </div>

        <div className="container w-auto h-100">
          <div className="title ">
            <h2 className="text-white !text-left font-bold">Programme sur mesure pour</h2>
          </div>
          <div className="d-flex" style={{background:"#FAF9F6 !important",overflow:"hidden"}}>
            <form action="" method="">
              <label>
                <span className="fname !text-left">
                  Prénom<span className="required">*</span>
                </span>
                <input type="text" name="fname" />
              </label>
              <label>
                <span className="lname !text-left">
                  Nom <span className="required">*</span>
                </span>
                <input type="text" name="lname" />
              </label>
              <label>
                <span className="!text-left">Nom de l'entreprise (facultatif)</span>
              ...
              <label>
                ...
                <select name="selection" className="w-75">
                  <option value="select">Choisissez une ville...</option>
                  <option value="TUN">Tunis</option>
                  <option value="ARI">Ariana</option>
                  <option value="SOUS">Sousse</option>
                  <option value="MONA">Monastir</option>
                </select>
              </label>
              <label>
                <span className="!text-left">
              ...
              <label>
                <span>&nbsp;</span>
                <input type="text" name="apartment" placeholder="Adresse 2" />
              </label>

              <label>
                <span className="!text-left">
                  Zip / code postal <span className="required">*</span>
                </span>
            ...
            <div className="Yorder h-100">
              <table>
                <tbody>
                  <tr>
                    <th colSpan="2">
                      Programme sur mesure pour <span> </span>
                    </th>
                  </tr>
                  <tr>
                    <td>
                      7 jours de repas Tnd / jour <br /> Papipets pour{" "}
                      <span>qaa</span>
                    </td>
                    <td></td>
                  </tr>
              ...
              <div className="text-left">
                <div>
                  <input type="radio" name="dbt" value="dbt" /> Virement bancaire direct
                  
                </div>
                <p className="mb-2">
                  Effectuez votre paiement directement sur notre compte
                  bancaire. Veuillez utiliser votre ID de commande comme
                  référence de paiement. Votre commande ne sera pas expédiée
                  tant que les fonds n'auront pas été crédités sur notre compte.
                </p>
                <div className="mb-2">
                  <input type="radio" name="dbt" value="cd" /> Paiement à la
                  livraison
                </div>
                <div className="mb-2 flex">
                  <input className="mb-2 mr-2" type="radio" name="dbt" value="cd" /> Carte de crédit
                  <img
                  className="ml-1"
              ...
              <button className="overflow-hidden" type="button">
                Passer la commande
              </button>
            </div>
          </div>
