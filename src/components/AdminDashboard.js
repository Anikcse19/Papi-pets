          ...
          >
            ...
            <div className="card-body py-0">
              <div className="table-responsive">
                <table
                  id="basic-table"
                  className="table mb-0 iq-table user-list-table"
                  role="grid"
                >
                  <thead>
                    <tr>
          ...
          >
            <div className="card-body d-flex align-items-center justify-content-between">
              <div className="col">
                ...
                <a href="#" className="btn bg-white rounded-pill">
                  View More
                </a>
              </div>
              <div className="col-2  card mb-0 bg-white card-body">
                <div>
                  <h6 className="heading-title mb-3 text-center">
                    Total Profit
                  </h6>
                </div>
                <div className=" text-center">
